...
const PROD_MESSAGING_ID = '249852503562'
...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('bracket-girl')
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
...
messaging.setBackgroundMessageHandler(function (payload) {
  ...
  const notificationTitle = 'Bracket-girl'
